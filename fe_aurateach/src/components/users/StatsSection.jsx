    ...
    <section class="stats-section">
      <div class="stats-container">
        ...
        <div class="stat-item">
          ...
          <h2 class="stat-number-text">
            <AnimatedCounter target={500} />+
          </h2>
          <p class="stat-label-text">Gia sư kinh nghiệm</p>
        </div>
        ...
        <div class="stat-item">
          <div class="stat-icon-wrapper">
            {/* Icon Cuốn sách */}
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 21.438s-3.188-3.125-9-3.125V5.313c5.813 0 9 3.124 9 3.124s3.188-3.124 9-3.124v13c-5.813 0-9 3.125-9 3.125zM12 8.438v13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          <h2 class="stat-number-text">
            <AnimatedCounter target={12} />+
          </h2>
          <p class="stat-label-text">Môn học phổ thông</p>
        </div>
        ...
        <div class="stat-item">
          <div class="stat-icon-wrapper">
            ...
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 15a6 6 0 100-12 6 6 0 000 12z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M8.21 13.89L7 21l5-3 5 3-1.21-7.12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          <h2 class="stat-number-text">
            <AnimatedCounter target={5000} isFormatted={true} />+
          </h2>
          <p class="stat-label-text">Giờ học đã hoàn thành</p>
        </div>
