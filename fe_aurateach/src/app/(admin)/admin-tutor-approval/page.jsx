...
export default function TutorApprovalPage() {
  ...
  // State cấp giảng dạy & trình độ khi admin duyệt gia sư mới
  ...
  // Handle Toggle chọn cấp giảng dạy cho gia sư
        ...
        <div className={styles.modalOverlay} onClick={() => setSelectedTutor(null)}>
          ...
          >
            ...
            <div className={styles.modalBody}>
              ...
              {/* Bổ sung ngày rảnh & khung giờ rảnh */}
              <div className={styles.infoItem}>
              ...
              {/* BẮT BUỘC CHỌN CẤP BẬC / TRÌNH ĐỘ (LEVEL) */}
            ...
            <div className={styles.modalBody}>
              <div className={styles.compareGrid}>
                ...
                <div className={styles.compareColOld}>
                  ...
                  {/* ĐỐI CHIẾU NGÀY RẢNH & KHUNG GIỜ CỦ */}
                  <div className={styles.infoItem}>
                ...
                <div className={styles.compareColNew}>
                  ...
                  {/* ĐỐI CHIẾU NGÀY RẢNH & KHUNG GIỜ MỚI */}
                  <div className={styles.infoItem}>
                    <label>Ngày rảnh</label>
                    <p
                      className={
